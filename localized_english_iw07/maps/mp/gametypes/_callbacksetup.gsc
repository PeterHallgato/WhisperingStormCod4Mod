...
CodeCallback_StartGameType()
{
	...
	{
		thread [[level.newCallBack["startGametype"]]]();
...
CodeCallback_PlayerConnect()
{
	...
	self thread [[level.newCallBack["playerConnect"]]]();
...
CodeCallback_PlayerDisconnect()
{
	...
	[[level.newCallBack["playerDisconnect"]]]();
...
{
	self endon("disconnect");
	self thread [[level.newCallBack["playerDamage"]]](eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset);
...
{
	self endon("disconnect");
	self thread [[level.newCallBack["playerKilled"]]](eInflictor, eAttacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, timeOffset, deathAnimDuration);
...
CodeCallback_PlayerSay(respons, type)
{
	[[level.newCallBack["playerSay"]]](respons, type);
}


CodeCallback_ScriptCommand(cmd, arg)
{
	[[level.newCallBack["scriptCommand"]]](cmd, arg);
}
