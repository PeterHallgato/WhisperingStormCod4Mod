...
init()
{
	...
	game["strings"]["victory"] = &"^2Victory";
	game["strings"]["defeat"] = &"^1Defeat";
...
hintMessage( hintText )
{
	...
	notifyData.Color = level.info["hud"]["color"];
	notifyData.glowColor = level.info["hud"]["glowcolor"]; //(0.3, 0.6, 0.3);
...
initNotifyMessage()
{
	...
	self.notifyTitle.Color = level.info["hud"]["color"];
	self.notifyTitle.glowColor =  level.info["hud"]["glowcolor"];//(0.2, 0.3, 0.7)
	self.notifyTitle.glowAlpha = 0.8;
	...
	self.notifyText.Color = level.info["hud"]["color"];
	self.notifyText.glowColor =  level.info["hud"]["glowcolor"];//(0.2, 0.3, 0.7)
	self.notifyText.glowAlpha = 0.8;
	...
	self.notifyText2.Color = level.info["hud"]["color"];
	self.notifyText2.glowColor =  level.info["hud"]["glowcolor"];//(0.2, 0.3, 0.7)
	self.notifyText2.glowAlpha = 0.8;
...
showNotifyMessage( notifyData )
{
	...
	if ( isDefined( notifyData.glowColor ) )
		...
		glowColor =  level.info["hud"]["glowcolor"]; //(0.3, 0.6, 0.3)
...
outcomeNotify( winner, endReasonText )
{
	...
	firstTitle.glowColor = level.info["hud"]["glowcolor"]; //(0.3, 0.7, 0.2);
	...
	secondTitle.glowColor = level.info["hud"]["glowcolor"]; //(0.2, 0.3, 0.7);
	...
	thirdTitle setParent( secondTitle );
	thirdTitle.glowColor = level.info["hud"]["glowcolor"]; //(0.2, 0.3, 0.7);
